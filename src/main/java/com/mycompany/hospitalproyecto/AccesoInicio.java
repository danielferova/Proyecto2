 ...
 * @author danielferova
 */
@WebServlet(name = "AccesoInicio", urlPatterns = {"/AccesoInicio"})
public class AccesoInicio extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
               NuevosAdmin ingresar = new NuevosAdmin();
        boolean estado = ingresar.verificarEstadoDB();
        if(estado)
        {
